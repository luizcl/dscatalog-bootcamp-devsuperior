...
create table tb_client (id int8 generated by default as identity, birth_date TIMESTAMP WITHOUT TIME ZONE, children int4, cpf varchar(255), income float8, name varchar(255), primary key (id));
